...
Edit [_pages/about.md](https://github.com/funailab/funailab.github.io/blob/main/_pages/about.md) and add the following to one of the staff sections:

```
    - name: The Name
      description: job title, date
      website: example.com [remove this line if there's no website]
      picture: funailab-logo-150.png [or replace with name.jpg]
```

To include a picture name.jpg, add it to [assets/img](https://github.com/funailab/funailab.github.io/tree/main/assets/img).
...
Add a new markdown file to [_pages](https://github.com/funailab/funailab.github.io/tree/main/_pages).
...
1. Add the plug-in to the `plugins` list in [_config.yml](https://github.com/funailab/funailab.github.io/blob/main/_config.yml).
2. Add it to the [Gemfile](https://github.com/funailab/funailab.github.io/blob/main/Gemfile).
3. Install it:
```
...
If there's no Dependabot PR, you can typically generate one via the repo's [security tab](https://github.com/funailab/funailab.github.io/security). 
You can also do this by hand: add the code suggested by the security alert (`gem "gem-name-here", ">= version.number.here"`) to the [Gemfile](https://github.com/funailab/funailab.github.io/blob/main/Gemfile) and update `Gemfile.lock` by running
```
gem install gem-name-here
